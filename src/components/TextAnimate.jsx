...
/**
 * TextAnimate — ported from Magic UI (https://magicui.design/docs/components/text-animate)
 * to plain JS. Animates text by character/word/line/text with a viewport trigger.
 */
